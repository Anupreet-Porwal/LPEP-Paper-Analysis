...
res.endometrial <-list("PIP"=pip.mat.ord,
                       "coef" = coef.mat.ord,
                       "model.probs"= model.list.ord,
                       "credible.int"=ci.methods)

save(res.endometrial,file = "C:/Users/Anupreet Porwal/Dropbox/Research/PEP-GLM/code/results/endometrial_res.Rda")
